...
func TestDomainTemplatesEmbedFS(t *testing.T) {
	t.Run("embedded FS contains expected template files", func(t *testing.T) {
		...
		expectedTemplates := []string{
			...
			"usecase_errors.go.tmpl",
			"mocks_test.go.tmpl",
			"create_usecase_test.go.tmpl",
			"get_usecase_test.go.tmpl",
			"update_usecase_test.go.tmpl",
			"delete_usecase_test.go.tmpl",
			"list_usecase_test.go.tmpl",
			"repository_interface.go.tmpl",
			"repository_postgres.go.tmpl",
			"repository_postgres_test.go.tmpl",
			"dto_create.go.tmpl",
			"dto_get.go.tmpl",
			"dto_list.go.tmpl",
			"dto_update.go.tmpl",
